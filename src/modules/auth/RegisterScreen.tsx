...
export default function RegisterScreen() {
  ...
  if (otpSent) {
    return (
      <View style={styles.container}>
        ...
        <Text style={{ fontSize: rf(22), marginBottom: 12 }}>Verify Phone Number</Text>
        <Text style={{ fontSize: rf(16), marginBottom: 20, textAlign: 'center', color: '#666' }}>
  ...
  return (
    <View style={styles.container}>
      <Text style={{ fontSize: rf(22), marginBottom: 12 }}>Create account</Text>
